export default {
  ...
  'messages.modelCard.credit': 'Cost',
  'messages.modelCard.creditPricing': 'Pricing',
  'messages.modelCard.creditTooltip':
    'Actual cost converted from the model pricing, shown in the pricing currency (e.g. ¥ or $).',
  'messages.modelCard.pricing.inputCachedTokens': 'Cached input {{amount}}/M tokens',
  'messages.modelCard.pricing.inputCharts': '${{amount}}/M characters',
  'messages.modelCard.pricing.inputMinutes': '${{amount}}/minute',
  'messages.modelCard.pricing.inputTokens': 'Input {{amount}}/M tokens',
  'messages.modelCard.pricing.outputTokens': 'Output {{amount}}/M tokens',
  'messages.modelCard.pricing.writeCacheInputTokens': 'Cache write {{amount}}/M tokens',
